    ...
    return(
        <>
         <div id="hireMe" className=' font-display flex flex-col justify-center bg-rippedPaperBottom bg-cover bg-no-repeat w-screen h-screen '>
            ...
            <a href="mailto:isaacnetti@gmail.com?subject=I'd like to work with you!?body=Hello! I have a job opportunity that I think you would be great for"><div className="mt-10 bg-hireMePaper bg-contain bg-no-repeat w-56 h-56 mx-auto"></div></a>
